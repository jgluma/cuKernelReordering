/**
 * @file cublasrotm.h
 * @details This file describes a class to implement a CUBLASROTM task.
 * @author Antonio Jose Lazaro Munoz.
 * @date 20/02/2016
 */
#ifndef _CUBLASROTM_H_
#define _CUBLASROTM_H_
...
/**
 * @class CUBLASROTM
 * @brief CUBLASROTM class.
 * @details This class implements a CUBLASROTM task.
 * @author Antonio Jose Lazaro Munoz.
 * @date 20/02/2016
 * 
 */
class CUBLASROTM : public Task
{
private:
	/**
	 * Host x vector.
...
public:
	/**
	 * @brief Constructor for the CUBLASROTM class.
	 * @details This function implements the constructor for the CUBLASROTM class. This
	...
	CUBLASROTM(int s);
	/**
	 * @brief Destroyer for the CUBLASROTM class.
	 * @details This function implements the destroyer for the CUBLASROTM class. This function
