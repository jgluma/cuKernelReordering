/**
 * @file FFT.h
 * @details This file describes a class to implement a FFT task.
 ...
 * @class FFT
 * @brief FFT class.
 * @details This class implements a FFT task.
 * @author Antonio Jose Lazaro Munoz.
 * @date 20/02/2016
 * 
 */
...
private:
	/**
	 * Host input data vector
	 */
	float2 *h_in;
	/**
	 * Host output data vector
	 */
	float2 *h_out;
	/**
	 * Device input data vector
	 */
	float2 *d_in;
	/**
	 * Device output data vector
	 */
	float2 *d_out;
	/**
	 * Vector size
...
public:
	/**
	 * @brief Constructor for the FFT class.
	 * @details This function implements the constructor for the FFT class. This
	...
	FFT(int s);
	/**
	 * @brief Destroyer for the FFT class.
	 * @details This function implements the destroyer for the FFT class. This function
