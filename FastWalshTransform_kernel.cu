/**
 * @file FastWalshTransform_kernel.cu
 * @details This file describes the kernel and device functions for a FastWalshTransform task.
 * @author Antonio Jose Lazaro Munoz.
 * @date 20/02/2016
 */
#ifndef _FASTWALSHTRANSFORM_KERNEL_H_
#define _FASTWALSHTRANSFORM_KERNEL_H_
/*
