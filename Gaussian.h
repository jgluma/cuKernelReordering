/**
 * @file Gaussian.h
 * @details This file describes a class to implement a Gaussian task.
...
/**
 * @class Gaussian
 * @brief Gaussian class.
 * @details This class implements a Gaussian task.
 * @author Antonio Jose Lazaro Munoz.
 * @date 20/02/2016
 * 
 */
...
public:
	/**
	 * @brief Default constructor for the Gaussian class.
	...
	Gaussian(int s);
	/**
	 * @brief Destroyer for the Gaussian class.
	 * @details This function implements the destroyer for the Gaussian class. This function
